  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">酒店客房管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='qingjierenyuan'" class="input-group">
			   <div class="label">清洁账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qingjiezhanghao" class="input" type="text" placeholder="清洁账号">
			   </div>
			 </div> -->
			...
			<!-- <div v-if="tableName=='qingjierenyuan'" class="input-group">
			   <div class="label">清洁姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qingjiexingming" class="input" type="text" placeholder="清洁姓名">
			   </div>
			 </div> -->
